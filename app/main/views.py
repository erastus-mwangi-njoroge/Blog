...
def add_article():
    ...
    return render_template('newArticle.html',title = title,articleform = form)


@main.route('/artcles/<int:article_id>/comment',methods=['POST','GET'])
@login_required
def comment(article_id):
    ...
    title = 'Articles'
    return render_template('artcles.html',title = title,article = article,comments=comments)
...
@main.route('/artcles/<int:article_id>/update',methods=['POST','GET'])
@login_required
def update(article_id):
    ...
    return render_template('newArticle.html',title = 'update article',articleform = form)


@main.route('/artcles/<int:article_id>/delete',methods=['POST'])
@login_required
